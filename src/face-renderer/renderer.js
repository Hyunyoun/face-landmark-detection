...
export function setupDatGui(state) {
...
export async function renderPrediction(state, video, model, ctx) {
  stats.begin();
  ...
  ctx.drawImage(
    video, 0, 0, videoWidth, videoHeight, 0, 0, VIDEO_SIZE, VIDEO_SIZE); //canvas.width, canvas.height);
